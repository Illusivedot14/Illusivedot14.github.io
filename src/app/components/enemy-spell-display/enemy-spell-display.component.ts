...
export class EnemySpellDisplayComponent implements OnInit {
  ...
  getEnemySpellMP4(spellName : string) : string {
    return "https://ia601502.us.archive.org/5/items/twrpg_guidebook/EnemySpells%2F" + encodeURI(this.category) + '%2F' + encodeURI(this.caster) + '%2F' + encodeURI(spellName) + ".mp4";
  }
